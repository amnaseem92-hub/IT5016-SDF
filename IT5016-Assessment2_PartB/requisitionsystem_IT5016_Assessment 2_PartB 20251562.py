...
class RequisitionSystem:
    ...
    # Auto approve if Total is < 500, otherwise Pending
...
# -------------------------------------------------------
# Step 1 Call - Program Starts running from here
# ------------------------------------------------------
...
if __name__ == "__main__":
    ...
    # Step 2 Call - This function of class calls at the end of all calculations as done above
